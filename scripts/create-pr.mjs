...
try {
  ...
  if (hasGh) {
    ...
    if (!isDryRun) {
      ...
      const extraArgs = process.argv.slice(2).filter((arg) => arg !== '--dry-run');
    ...
    const repoUrl = 'https://github.com/luiz-shonen/organiza-ai';
    const compareUrl = `${repoUrl}/compare/main...${encodeURIComponent(currentBranch)}?expand=1`;

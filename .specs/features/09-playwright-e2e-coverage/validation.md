...
| PW-21 | WHEN major milestone is reached THEN capture visual screenshot | Capture full-page PNG baselines across 7 milestone views with separate Desktop and Mobile outputs | `e2e/pages/base.page.ts:37` - `await this.page.screenshot({ path: \`e2e/screenshots/\${name}-\${deviceSuffix}.png\` })` | ✅ PASS |

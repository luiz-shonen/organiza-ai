...
describe('OrgDialogService', () => {
  it('maps dialog closing values to a boolean confirmation result', () => {
    ...
    TestBed.configureTestingModule({ providers: [OrgDialogService, { provide: MatDialog, useValue: { open } }] });
    const service = TestBed.inject(OrgDialogService);
    let result: boolean | undefined;
    service.confirm({ title: 'Excluir', message: 'Confirmar exclusão?' }).subscribe((value) => { result = value; });
